...
<!--            <a href="">电脑、办公</a>-->
        <?php
        $cate=\backend\models\GoodsCaetgory::findOne(Yii::$app->request->get('id'));
        echo \yii\helpers\Html::a($cate->name,['list','id'=>$cate->id]);
        ?>
        </h2>
    </div>
    <!-- 面包屑导航 end -->
    ...
    <div class="list_bd fl ml10 mt10">
        ...
        <div class="goodslist mt10">
            <ul>
                ...
                <li>
                    <dl>
                        <dt><?=\yii\helpers\Html::a(\yii\helpers\Html::img($good->logo),['goods','g_id'=>$good->id])?></dt>
                        <dd><?=\yii\helpers\Html::a($good->name,['goods','g_id'=>$good->id])?></dt>
                        <dd><strong>￥<?=$good->price;?></strong></dt>
