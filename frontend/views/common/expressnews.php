<div class="colligate w1210 bc mt10">
    ...
    <div class="slide fl">
        <div class="area">
            <div class="slide_items">
                <ul>
                    <li><a href=""><?=\yii\bootstrap\Html::img('@web/images/index_slide1.jpg')?></a></li>
                    <li><a href=""><?=\yii\bootstrap\Html::img('@web/images/index_slide2.jpg')?></a></li>
                    <li><a href=""><?=\yii\bootstrap\Html::img('@web/images/index_slide3.jpg')?></a></li>
                    <li><a href=""><?=\yii\bootstrap\Html::img('@web/images/index_slide4.jpg')?></a></li>
                    <li><a href=""><?=\yii\bootstrap\Html::img('@web/images/index_slide5.jpg')?></a></li>
                    <li><a href=""><?=\yii\bootstrap\Html::img('@web/images/index_slide6.jpg')?></a></li>
                </ul>
            </div>
    ...
    <div class="coll_right fl ml10">
        <div class="ad"><a href=""><?=\yii\bootstrap\Html::img('@web/images/ad.jpg')?></a></div>
        ...
        <div class="service mt10">
            ...
            <div class="service_wrap">
                ...
                <div class="travel none">
                    <ul>
                        <li>
                            <a href=""><?=\yii\bootstrap\Html::img('@web/images/holiday.jpg')?></a>
                            <a href="" class="button">度假查询</a>
                        </li>
                        <li>
                            <a href=""><?=\yii\bootstrap\Html::img('@web/images/scenic.jpg')?></a>
                ...
                <div class="lottery none">
                    <p><?=\yii\bootstrap\Html::img('@web/images/lottery.jpg')?></p>
                </div>
                <!-- 彩票 end -->
                ...
                <div class="game none">
                    <ul>
                        <li><a href=""><?=\yii\bootstrap\Html::img('@web/images/sanguo.jpg')?></a></li>
                        <li><a href=""><?=\yii\bootstrap\Html::img('@web/images/taohua.jpg')?></a></li>
                        <li><a href=""><?=\yii\bootstrap\Html::img('@web/images/wulin.jpg')?></a></li>
                    </ul>
                </div>
                <!-- 游戏 end -->
            </div>
